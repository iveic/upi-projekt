	...
	<div class="row" style="margin-top: 50px;">
        <form style="width: 100%" action='{{form_akcija}}' method='POST'>
			<div class="form-group">
                <label for="vrstapodrucja">Novo podrucje</label>
                <input type="text" class="form-control" id="vrstapodrucja" name='vrstapodrucja' aria-describedby="vrstapodrucja-help" placeholder="Unesite vrstu podrucja" required>
            </div>
			
			<label for="zona">Zona</label><br>
			<select type="number" id = "zona" name="zona"></select>
			<script>
