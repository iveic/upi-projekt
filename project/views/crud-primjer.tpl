  ...
  <div class="container">
	...
	<div class="row">
		...
		<div class="flex-container" style="padding: 0">
			<div><a href='/ispis-karata' class="btn btn-dark">Ispis karata</a></div>
			<div><a href='/nova-karta' class="btn btn-dark">Nova vrsta karte</a></div>
			<div><a href='/novo-podrucje' class="btn btn-dark">Nova vrsta podrucja</a></div>
			<div><a href='/nova-zona' class="btn btn-dark">Nova zona</a></div>
		</div>
  </div>
