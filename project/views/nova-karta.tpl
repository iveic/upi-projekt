	...
	<div class="row" style="margin-top: 50px;">
        <form style="width: 100%" action='{{form_akcija}}' method='POST'>
			<div class="form-group">
                <label for="vrstakarte">Nova vrsta</label>
                <input type="text" class="form-control" id="vrstakarte" name='vrstakarte' aria-describedby="vrstakarte-help" placeholder="Unesite vrstu karte" required>
            </div>
