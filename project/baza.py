...
def unesi_demo_podatke():
    ...
    try:
        ...
        cur.execute("INSERT INTO putnik (ime_prezime, email) VALUES (?, ?)", ("ImePrezime1", "mail_1@gmail.com"))
        cur.execute("INSERT INTO putnik (ime_prezime, email) VALUES (?, ?)", ("ImePrezime2", "mail_2@gmail.com"))
...
def dodaj_novu_vrstu_karte(nova_vrsta):
    ...
    try:
        ...
        print("uspjesno unesena nova vrsta karte")
        conn.commit()
